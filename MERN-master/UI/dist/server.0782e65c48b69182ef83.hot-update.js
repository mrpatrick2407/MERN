...
class IssueList extends (react__WEBPACK_IMPORTED_MODULE_3___default().Component) {
  ...
  render() {
    ...
    if (pages) {
      ...
      prevpage = `?page=${prevSection}`;
      prevpage = prevpage.toString();
      nextpage = `?page=${nextSection}`;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("92920ccbb2c2860b0e46")
/******/ })();
/******/ 
/******/ }
;
//# sourceMappingURL=server.0782e65c48b69182ef83.hot-update.js.map