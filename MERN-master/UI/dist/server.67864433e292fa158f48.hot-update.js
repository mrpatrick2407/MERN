...
class IssueAdd extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return /*#__PURE__*/(0,react_dom__WEBPACK_IMPORTED_MODULE_4__.createPortal)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__.Button, {
      variant: "secondary",
      onClick: () => {
        this.setState({
          showmodal: true
      ...
      variant: "secondary"
    }, "Cancel")))))), document.getElementById('modal'));
  }
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("187b3e0f433259c8cb24")
/******/ })();
/******/ 
/******/ }
;
//# sourceMappingURL=server.67864433e292fa158f48.hot-update.js.map