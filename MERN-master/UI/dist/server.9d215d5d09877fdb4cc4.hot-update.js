...
class IssueList extends (react__WEBPACK_IMPORTED_MODULE_3___default().Component) {
  ...
  render() {
    ...
    if (pages) {
      ...
      prevpage = `issues/?${prevSection}`;
      prevpage = `issues/?${nextSection}`;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b5d0490b2a8b034dc01b")
/******/ })();
/******/ 
/******/ }
;
//# sourceMappingURL=server.9d215d5d09877fdb4cc4.hot-update.js.map