...
class IssueList extends (react__WEBPACK_IMPORTED_MODULE_3___default().Component) {
  ...
  restoreissue(issue, index) {
    this.setState(prevState => {
      const lastissues = [...prevState.issues];
      lastissues.splice(index, 0, issue);
      return {
        issues: lastissues
      };
    });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6d7150c68d905719fadf")
/******/ })();
/******/ 
/******/ }
;
//# sourceMappingURL=server.c2b5fbb87ff275e30625.hot-update.js.map