...
/* harmony import */ var _graphqlendppoint__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./graphqlendppoint */ "./src/graphqlendppoint.js");
...
class IssueReport extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  async loaddata() {
    ...
    const data = await (0,_graphqlendppoint__WEBPACK_IMPORTED_MODULE_4__.graphqlendpoint)(query, vars);
    if (data) {
      this.setState({
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("98dc7d069e4293dd132d")
/******/ })();
/******/ 
/******/ }
;
//# sourceMappingURL=server.ef0d388d74e136a2c82e.hot-update.js.map